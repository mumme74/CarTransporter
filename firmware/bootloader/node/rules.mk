...
srec: $(BINARY).srec
list: $(BINARY).list
GENERATED_BINARIES=$(OUTDIR)/$(TARGET).elf $(OUTDIR)/$(TARGET).bin $(OUTDIR)/$(TARGET).hex \
				   $(OUTDIR)/$(TARGET).srec $(OUTDIR)/$(TARGET).list $(OUTDIR)/$(TARGET).map
