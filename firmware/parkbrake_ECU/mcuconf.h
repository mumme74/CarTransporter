...
#define STM32_PLLMUL_VALUE                  3 // 24MHz oscillator 3*24=72Mhz
#define STM32_HPRE                          STM32_HPRE_DIV1 // AHB prescaler
#define STM32_PPRE1                         STM32_PPRE1_DIV2 // APB lowspeed prescaler
#define STM32_PPRE2                         STM32_PPRE2_DIV2 // APB highspeed prescaler 72Mhz/2=36Mhz
#define STM32_MCOSEL                        STM32_MCOSEL_NOCLOCK
#define STM32_ADCPRE                        STM32_ADCPRE_DIV4 // ADC prescaler from APB2 36MHz/4=8MHz
...
#define STM32_ICU_USE_TIM3                  TRUE /* actually used in homegrown driver tmr_compare.c */
